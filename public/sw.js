...
const SHELL_CACHE = 'mfsarthi-shell-v2'
const RUNTIME_CACHE = 'mfsarthi-runtime-v2'
// Derive the mount path from the worker's own URL so the app works at any
// base (domain root locally, /automation-agent/ on GitHub Pages).
